        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/dashboard"
                className="text-sm text-cyan-300 hover:text-cyan-200 transition-colors drop-shadow-[0_0_5px_rgba(103,232,249,0.5)]"
              >
                Dashboard
              </Link>
            </div>
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-fuchsia-500 to-violet-600 flex items-center justify-center shadow-[0_0_30px_rgba(217,70,239,0.8)] animate-pulse">
          ...
          {/* Error Display */}
          {error && (
            <div className="mb-6 bg-red-950/30 border-2 border-red-500/50 rounded-xl p-4 shadow-[0_0_30px_rgba(239,68,68,0.3)]">
          ...
          {showCreateForm && (
            <div className="mb-6 bg-slate-950/70 backdrop-blur-sm border-2 border-fuchsia-500/40 shadow-[0_0_40px_rgba(217,70,239,0.4)] rounded-2xl p-6">
              <h3 className="text-xl font-bold text-fuchsia-300 mb-4 drop-shadow-[0_0_10px_rgba(232,121,249,0.5)]">
              ...
              <form onSubmit={handleCreatePortfolio} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-slate-900/50 border-2 border-violet-500/50 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-500/50 shadow-[0_0_20px_rgba(139,92,246,0.2)] focus:shadow-[0_0_30px_rgba(217,70,239,0.4)] transition-all"
                    required
                  />
                </div>
                <div>
          ...
          {/* Loading State */}
          {loading && (
            <div className="bg-slate-950/70 backdrop-blur-sm border-2 border-violet-500/40 shadow-[0_0_40px_rgba(139,92,246,0.4)] rounded-2xl p-8">
              <div className="animate-pulse space-y-4">
                <div className="h-6 bg-violet-900/50 rounded w-3/4 shadow-[0_0_10px_rgba(139,92,246,0.3)]"></div>
          ...
          {!loading && portfolios.length === 0 && (
            <div className="bg-slate-950/70 backdrop-blur-sm border-2 border-cyan-500/40 shadow-[0_0_40px_rgba(34,211,238,0.4)] rounded-2xl p-8 text-center">
          ...
          {!loading && portfolios.length > 0 && (
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {portfolios.map((portfolio) => (
                <div
                  key={portfolio.id}
                  className="group bg-slate-900/60 backdrop-blur-sm rounded-xl border-2 border-fuchsia-500/50 hover:border-fuchsia-400 p-6 transition-all duration-300 shadow-[0_0_30px_rgba(217,70,239,0.3)] hover:shadow-[0_0_50px_rgba(217,70,239,0.6)] hover:transform hover:scale-105 cursor-pointer"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-fuchsia-300 group-hover:text-fuchsia-200 transition-colors drop-shadow-[0_0_10px_rgba(232,121,249,0.5)]">
                        {portfolio.name}
                      </h3>
                      {portfolio.is_default && (
                        <span className="inline-flex items-center gap-1 mt-1 text-xs text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.6)]">
                    ...
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center shadow-[0_0_20px_rgba(217,70,239,0.6)] group-hover:shadow-[0_0_30px_rgba(217,70,239,0.9)] transition-all">
                      <svg className="w-5 h-5 text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                      </svg>
                    </div>
                  </div>
