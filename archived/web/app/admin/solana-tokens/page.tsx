...
import SolanaTokensClient from "./components/SolanaTokensClient";

export default async function SolanaTokensPage() {
      ...
      <div className="max-w-5xl">
        <div className="bg-slate-950/70 backdrop-blur-sm border-2 border-fuchsia-500/40 shadow-[0_0_40px_rgba(217,70,239,0.4)] rounded-2xl p-6">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6">
            ...
            <span>/</span>
            <span className="text-slate-200">Solana Tokens</span>
          </div>
          ...
          <p className="text-slate-400 text-sm mb-6">
            Manage the SPL tokens that are checked during Solana wallet account sync.
